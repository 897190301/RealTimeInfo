...
public class XRecyclerView extends RecyclerView {
    ...
    public void startRefresh(){
        if(mRefreshHeader.getState()!=BaseRefreshHeader.STATE_REFRESHING){
            mRefreshHeader.onMove(ScreenUtils.dip2px(mContext,70));
    ...
    public void loadMoreComplete() {
        ...
        if (footView instanceof LoadingMoreFooter) {
            ...
            // recyclerview的滚动问题
            this.smoothScrollBy(0, ScreenUtils.dip2px(mContext,-41));
        }else {
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public WrapAdapter(ArrayList<View> headerViews,
                           ArrayList<View> footViews, Adapter adapter) {
